      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center gap-12 px-6 lg:flex-row lg:px-8">
        ...
        >
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            I'm <span className="font-bold text-white">Jitesh</span>, a
            front-end developer specializing in transforming ideas into fluid,
            high-performance web applications. My passion lies in creating
            intuitive interfaces that provide a seamless user experience.
          </p>
          <p className="mt-4 text-lg leading-8 text-gray-300">
            I leverage the power of{" "}
            ...
            to build things that are not only beautiful on the outside but also
            clean and scalable on the inside. Let's build something amazing
            together.
          </p>
        </motion.div>
      </div>
